...
MODEL_PATH = os.getenv("YOLO_ONNX", "/app/models/yolov8n.onnx")
...
def _letterbox(im, new_shape=640):
    w, h = im.size
...
def detect(image_path: str):
    ...
    im_lb, scale, pad_x, pad_y, orig_w, orig_h = _letterbox(im, 640)
    ...
    keep = _nms(boxes, cls_conf, IOU_THRES)
    boxes = boxes[keep]
    cls_id = cls_id[keep]
